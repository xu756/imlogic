...
func (c *userClient) GetUserInfo(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*UserInfo, error) {
	out := new(UserInfo)
...
func (UnimplementedUserServer) GetUserInfo(context.Context, *Empty) (*UserInfo, error) {
